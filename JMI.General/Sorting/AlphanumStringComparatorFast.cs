...
namespace JMI.General.Sorting
{
    /// <summary>
    /// Sorting algorithm logically handles numbers in strings (natural sort, not ASCII-sort).
    /// From https://www.dotnetperls.com/alphanumeric-sorting
    /// </summary>
    public class AlphanumStringComparatorFast : IComparer<string>
    {
